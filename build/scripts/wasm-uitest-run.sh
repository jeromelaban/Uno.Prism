...
msbuild /r /p:Configuration=Release /p:DISABLE_GITVERSIONING=true $BUILD_SOURCESDIRECTORY/e2e/Uno/$TARGET_XAML_FLAVOR/HelloUnoWorld.Wasm/HelloUnoWorld.Wasm.csproj
